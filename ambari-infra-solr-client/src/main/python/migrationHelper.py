...
if __name__=="__main__":
  ...
  parser.add_option("--async", dest="async_op", action="store_true", default=False, help="async Ambari operations (backup | restore | migrate)")
  ...
  parser.add_option("--version", dest="index_version", type="string", default="6.6.2", help="lucene index version for migration (6.6.2 or 7.6.0)")
